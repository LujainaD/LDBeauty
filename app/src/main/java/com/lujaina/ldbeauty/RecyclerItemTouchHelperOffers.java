...
public class RecyclerItemTouchHelperOffers extends ItemTouchHelper.SimpleCallback {
    ...
    public RecyclerItemTouchHelperOffers(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
    ...
    public void clearView(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder) {
        ...
        View forgroundView = ((OfferAdapter.MyViewHolder)viewHolder).viewForground;
