...
public class RecyclerItemTouchHelperFeedback extends ItemTouchHelper.SimpleCallback {


    private RecyclerItemTouchHelperListener listener;

    public RecyclerItemTouchHelperFeedback(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
    ...
    public void clearView(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder) {
        ...
        View forgroundView = ((RatingAdapter.MyViewHolder)viewHolder).viewForground;
